...
> = {
  Steps: {
    ...
    rows: [
      { primary: "Loading team form" },
      { primary: "Computing match probabilities" },
      { primary: "Comparing recent meetings", secondary: "head-to-head" },
      { primary: "Writing the analysis" },
    ],
  },
  Reasoning: {
    active: "Reasoning",
    ...
    rows: [
      { primary: "Away games are historically tougher, but the opponent's xG form is below average." },
      { primary: "Home advantage at the Bernabéu plus strong scoring form tips the balance." },
    ],
  },
  Search: {
    active: "Checking the latest news",
    done: "News checked",
    query: "latest Real Madrid news",
    rows: [
      { primary: "Managing Madrid", secondary: "managingmadrid.com", href: "https://www.managingmadrid.com/" },
      { primary: "Transfer & injury updates", secondary: "latest", href: "https://www.managingmadrid.com/" },
      { primary: "Match previews", secondary: "preview", href: "https://www.managingmadrid.com/" },
    ],
  },
  Coding: {
    ...
    rows: [
      { primary: "Fixtures", secondary: "next match", mono: true },
      { primary: "Prediction", secondary: "win/draw/loss", mono: true },
      { primary: "News", secondary: "latest articles", mono: true },
    ],
  },
};
...
export default function ThinkingState({
  ...
  const v = rows
    ? { active: activeLabel, done: doneLabel, rows, query }
